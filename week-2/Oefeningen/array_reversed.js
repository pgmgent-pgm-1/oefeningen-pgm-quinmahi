...
_____________________________`);
// Variables
const arr = ["betalen.", 7000, "€", "kaas", "voor", "zou", "Ik", "lekker!", "is", "Kaas"]
const arrIndex = arr.length;
let line = "";
const seperator = " ";

// Loop
for (let i = arrIndex - 1; i >= 0; i--) { // i = (hoogste - 1)index van arr, vanaf dat i kleinder dan of gelijk aan 0 is stop het, zo niet dan gaat er 1 af van de index 
    if (i >= 0) {
